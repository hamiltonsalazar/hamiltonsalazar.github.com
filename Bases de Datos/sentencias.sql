DROP DATABASE IF EXISTS libreria_cf; -- DROP DATABASE libreria_cf;
CREATE DATABASE IF NOT EXISTS libreria_cf; -- CREATE DATABASE libreria_cf;
...
VALUES  ('Smith', 'Carvajal', 'smithcrvjl', 'hamiltonsmith@hotmail.es'),
        ('Hamilton', 'Salazar', 'hamiltonsalazar', 'hamiltonsalazar22@gmail.com');
