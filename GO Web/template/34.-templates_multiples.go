...
func main(){
	http.HandleFunc("/", func(w http.ResponseWriter, r *http.Request){
		...
		// template, err := template.ParseFiles("index.html") // ParseFiles 										como función

		// crear template anexando las funciones
		template, err := template.New("index.html").Funcs(funciones).ParseFiles("index.html", "footer.html", "header.html") //	ParseFiles como método
